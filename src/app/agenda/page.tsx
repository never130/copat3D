    ...
    <main className="flex-1">
      ...
      <div className="overflow-x-clip">
        <div className="relative mx-auto max-w-7xl px-5 py-20">
          ...
          {/* El interruptor vive en src/content/agenda.ts: mientras el
              cronograma no esté cerrado se muestra este placeholder, que es
              diseño intencional y no un pendiente olvidado (ver AGENTS.md).
              Así la agenda se puede ir cargando de a poco, a medida que los
              speakers confirman, sin publicarla a medio armar. */}
          {AGENDA_CONFIRMADA ? (
            <Cronograma />
          ) : (
            <>
